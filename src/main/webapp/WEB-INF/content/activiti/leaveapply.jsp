                ...
                <div class="box-content">
                    <form role="form" action="startleave" method="post">
                        <div class="form-group">
                            <label>请假类型</label> <select name="leave_type" class="form-control">
                        ...
                        <div class="form-group has-feedback">
                            ...
                            <input id="start" class="form-control" name="start_time" placeholder="开始时间">
                            <span class="fa fa-calendar txt-danger form-control-feedback"></span>
                        </div>
                        <div class="form-group has-feedback">
                            <label>结束时间</label> <input id="end" class="form-control" name="end_time" placeholder="结束时间">
                            <span class="fa fa-calendar txt-danger form-control-feedback"></span>
                        </div>
                        <div class="form-group">
                            <label>请假原因</label>
